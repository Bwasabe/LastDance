...
public class KawaseBlur : ScriptableRendererFeature
{
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            // RenderTargetIdentifier identifier1 = new(tmpId1);
            tmpRT1 = new(tmpId1);
            tmpRT2 = new(tmpId2);
            // tmpRT1 = RTHandles.Alloc(identifier1, "tmpBlurRT1");

            // RenderTargetIdentifier identifier2 = new(tmpId2);
            // tmpRT2 = RTHandles.Alloc(identifier2, "tmpBlurRT1");
